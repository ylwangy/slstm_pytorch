...
def clue_convert_examples_to_features(examples, tokenizer,
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        if example.text_b:
            sent_ids2=tokenizer.sp.encode(example.text_b) 
...
#{"target": {"span2_index": 35, "span1_index": 6, "span1_text": "洋人", "span2_text": "他们"}, 
# "idx": 1, "label": "true", "text": "有些这样的“洋人”就站在大众之间，如同鹤立鸡群，毫不掩饰自己的优越感。
# 他们排在非凡的甲菜盆后面，虽然人数寥寥无几，但却特别惹眼。"}

#塑料椅子这边坐着很多候烧者，沙发那边只有_五个候烧者_，[他们]舒适地架着二郎腿，
#都是一副功成名就的模样，塑料椅子这边的个个都是正襟危坐。
